...
@Component({
  selector: 'app-scheduling-programs',
  imports: [
    CommonModule,
  ...
  templateUrl: './scheduling-programs.component.html',
  styleUrls: ['./scheduling-programs.component.scss'],
  animations: [fadeAnimation, pageFloatUpAnimation],
})
export class SchedulingProgramsComponent implements OnInit, OnDestroy {
  schedules: Schedule[] = [];
